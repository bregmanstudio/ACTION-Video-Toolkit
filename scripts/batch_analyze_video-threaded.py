...
def actionAnalyzeAll(hlist, olist):
...
def actionOFlowWorker(ofile):
	oflow = action.opticalflow24.OpticalFlow24(ofile, action_dir=ACTIONDIR)
...
if __name__ == '__main__':
	...
	actionAnalyzeAll(hists_to_analyze, oflows_to_analyze)
