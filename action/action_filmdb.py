class FilmDB:
	...
	def _initialize(self, params):
		...
		self.actionDB = {
			...
			'Fata_Morgana': ['Fata_Morgana', 'other', 1, 9999],
			...
			'How_to_Survive_a_Plague' : ['How_to_Survive_a_Plague', 'other', 1, 9999],
			...
			'Ivans_Childhood' : ['Ivans_Childhood', 'other', 0, 9999],
			...
			'THe_Mirror': ['The_Mirror', 'other', 0, 9999],
			...
			'The_Sacrifice' : ['The_Sacrifice', 'other', 1, 9999],
		...
		self.actionDocumentariesDB = {
			...
			'Murrow_Harvest' : ['Murrow_Harvest', '', 0, 9999],			
