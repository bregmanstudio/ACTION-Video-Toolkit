...
//        flowColorImg.flagImageChanged();
    ...
    cv::Mat computeHistogramOfOrientedMotionGradients(bool display=true)
    {
    ...
    {
//        cout << "----------------------" << endl;
//        cout << "x0: " << float(x) << endl;
//        cout << "y0: " << float(y) << endl;
//        cout << "w0: " << float(w) << endl;
//        cout << "h0: " << float(h) << endl;
//        cout << "ratio: " << float(ratio) << endl;
        x*=ratio;
        y*=ratio;
        w*=ratio;
        h*=ratio;
//        cout << "----------------------" << endl;
//        cout << "x1: " << float(x) << endl;
//        cout << "y1: " << float(y) << endl;
//        cout << "w1: " << float(w) << endl;
//        cout << "h1: " << float(h) << endl;
        IplImage *img = magImg.getCvImage();
        CvRect old_roi = cvGetImageROI(img);
//        cout << "************" << endl;
//        cout << img->width << endl;
//        cout << img->height << endl;
//        cout << old_roi.width << endl;
//        cout << old_roi.height << endl;
    ...
    double getFlowDevForROI(int x, int y, int w, int h)
    {
        x*=ratio;
        y*=ratio;
        w*=ratio;
